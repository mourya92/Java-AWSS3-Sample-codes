...
public class UploadtestObject {

    public static void main(String[] args) {
           String clientRegion = "us-east-1";
           String bucketName = "";
           String keyNameToEncrypt = "index.html";
           ...
           try {
        	   BasicAWSCredentials creds = new BasicAWSCredentials("M",
       				"u9");
              
        	   AmazonS3 s3Client = AmazonS3ClientBuilder.standard()
                                       //.withRegion(clientRegion)
                                       .withCredentials(new AWSStaticCredentialsProvider(creds))
                                       .withEndpointConfiguration(new EndpointConfiguration("http://10.219.46.76:8080", "us-east-1"))
               ...
               String fileName = "/Users/ssmourya/Downloads/temp_10GB_file.1cdBa63d";
