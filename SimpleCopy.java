...
public class SimpleCopy {
	...
	public static void main(String[] args) {
		...
		BasicAWSCredentials creds = new BasicAWSCredentials("AA",
				"");
		...
		try {
			...
			CopyObjectRequest copyObjectRequest = new CopyObjectRequest(srcbucket, srckey2, destbucket, srckey2);

			GetObjectTaggingRequest getTaggingRequest = new GetObjectTaggingRequest(srcbucket, srckey2);
			GetObjectTaggingResult getTagsResult = s3client.getObjectTagging(getTaggingRequest);

			ObjectTagging objectTagging = null;

			objectTagging = new ObjectTagging(getTagsResult.getTagSet());
			//objectTagging = new ObjectTagging(new ArrayList<Tag>());
